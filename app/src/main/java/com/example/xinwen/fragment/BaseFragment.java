...
import com.example.xinwen.NewInfo;
import com.example.xinwen.NewsInfoAdapter;
import com.example.xinwen.R;
import com.example.xinwen.Utils;
import okhttp3.Call;
...
public abstract class BaseFragment extends Fragment {
    ...
    public void getDataFromServer(String type) {
        // 拼接出一个新闻类型的访问请求。
        String newsUrl = "http://v.juhe.cn/toutiao/index?type=" + type + "&key=e8491aadf6d23cd8c410066da2a9c064";
